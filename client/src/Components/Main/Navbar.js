        ...
        <>
            <nav className="p-3 bg-white-900 sticky top-0 z-10 dark:bg-gray-bg">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                        <>
                            <DropDown title="About Us" children={["Home", "About Jeevandan", "Contact Us"]} links={["/", "/about", "/contactUs"]}></DropDown>
                            {props.logIn ? (
                                <>
                                    <Link
                                ...
                                <>
                                    <DropDown title="Looking For Blood" children={["Patient Login/Register"
                                    // , "Blood Bank Directory"
                                    ]} links={["/register/patient", "/bloodDirect"]}></DropDown>
                                    <DropDown title="Want To Donate Blood" children={["Donor Login/Register", 
                                    // "Blood Donation Camps", 
                                    "About Blood Donation"]} links={["/register/donor", 
                                    // "/bloodCamps", 
                                    "/aboutBloodDonation"]}></DropDown>
